		...
		<div class="row">
			...
			<main class="posts-listing col-lg-8">
				<div class="container">
					...
					<div class="row">
								...
								<div class="post col-xl-6">
									<div class="post-thumbnail">
										<a
											...
											src="${pageContext.request.contextPath}${postList[i].image }" alt="..." class="post-image"></a>
									</div>
									<div class="post-details">
										...
										<footer class="post-footer d-flex align-items-center">
											<a
												...
												<div class="avatar">
													<img src="${pageContext.request.contextPath}${postList[i].author.image }" alt="..." class="img-fluid">
												</div>
												<div class="title">
						...
						<c:if test="${postList.size() == 0 }">
							<h2 class="not-news">Nema vesti za ovaj tag</h2>
						</c:if>
					</div>
			...
			<aside class="col-lg-4">
				...
				<div class="widget tags">
					<header>
						<h3 class="h6">Tagovi</h3>
					</header>
					<div>
						<c:forEach var="tag" items="${tagList }">
							<div class="item d-flex justify-content-between">
								<a href="blog-tag-page?id=${tag.id }&title=${tag.name}">${tag.name }</a><span>${tag.posts.size() }</span>
							</div>
						</c:forEach>
					</div>
				</div>
