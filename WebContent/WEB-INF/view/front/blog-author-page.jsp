      ...
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            ...
            <h2 class="mb-3">Autor: "${author.name }"</h2>
...
<%--               <c:if test="${fn:length(postList) > 0}"> --%>
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  <div class="post-meta d-flex justify-content-between">
					...
					<p class="text-muted">${fn:substring(postList[i].header,0,200)}...</p>                  <footer class="post-footer d-flex align-items-center"><a href="blog-author-page?username=${postList[i].author.username}" class="author d-flex align-items-center flex-wrap">
              ...
              <c:if test="${postList.size() == 0 }">
              	<h2 class="not-news">Nema vesti za ovog autora</h2>
              </c:if>
            </div>
          </div>
        </main>
